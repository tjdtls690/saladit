...
<div data-v-7605e1b2="" tabindex="-1"
	class="vc-popover-content direction-bottom vc-rounded-lg vc-text-sm vc-font-semibold vc-text-white vc-bg-gray-800 vc-border vc-border-gray-700 vc-p-1 vc-shadow">
	<div data-v-4a5f2beb="" class="vc-nav-container">
		<div data-v-3ca35a05="" class="vc-grid-container"
			...
			<div data-v-3ca35a05=""
				...
				<span data-v-3ca35a05="" role="button" tabindex="0"
					...
					style="white-space: nowrap;"> ${currentYear } - ${currentYear + 11 } </span>
			</div>
			<div data-v-3ca35a05=""
		...
		<div data-v-3ca35a05="" class="vc-grid-container"
			...
			<c:forEach var="list" items="${list }" varStatus="i">
				<c:if test="${check == 3 }">
					<c:if test="${currentYear + i.index < solidCheckYear }">
						<div data-v-3ca35a05=""
							...
							<span data-v-3ca35a05="" role="button" aria-label="2017" id="${currentYear + i.index }/00/00"
								...
								${currentYear + i.index } </span>
						</div>
					</c:if>
						
					<c:if test="${currentYear + i.index >= solidCheckYear }">
						<div data-v-3ca35a05=""
							class="vc-grid-cell vc-grid-cell-row-3 vc-grid-cell-row--2 vc-grid-cell-col-1 vc-grid-cell-col--3"
							style="grid-area: ${i.index / 3 + 1}/${i.index % 3 + 1}/auto/auto;">
							<span data-v-3ca35a05="" role="button" aria-label="2022"
								tabindex="0" id="${currentYear + i.index }/00/00"
