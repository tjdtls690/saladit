...
<!DOCTYPE html>
<div
	class="swal2-container swal2-bottom toast-container-class swal2-backdrop-show"
	...
	<div aria-labelledby="swal2-title" aria-describedby="swal2-content"
		...
		<div class="swal2-header">
			...
			<h2 class="swal2-title" id="swal2-title" style="display: flex;">배송지가
				등록되었습니다.</h2>
		...
		<div class="swal2-actions" style="display: none;">
			<button type="button" class="swal2-confirm swal2-styled"
				aria-label=""
				style="display: none; border-left-color: rgb(105, 226, 190); border-right-color: rgb(105, 226, 190);">OK</button>
