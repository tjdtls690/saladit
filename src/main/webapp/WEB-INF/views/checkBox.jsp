...
<div class="swal2-container swal2-center swal2-backdrop-show"
	...
	<div aria-labelledby="swal2-title" aria-describedby="swal2-content"
		class="swal2-popup swal2-modal swal2-icon-info swal2-show" id="swal2-show"
		...
		<div class="swal2-content">
			<div id="swal2-content" class="swal2-html-container"
				style="display: block;">인증번호가 전송되었습니다. 휴대전화에서 인증번호를 확인하고 인증번호를
				입력해 주세요.</div>
		...
		<div class="swal2-actions">
			<button type="button" class="swal2-confirm swal2-styled" onclick="closeBtn();"
				aria-label=""
