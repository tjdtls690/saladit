		...
		<div aria-labelledby="swal2-title" aria-describedby="swal2-content"
			...
			<div class="swal2-content">
				<div id="swal2-content" class="swal2-html-container"
					style="display: block;">비밀번호를 입력해주세요.</div>
...
<c:if test="${check == -1 }">
	<div class="swal2-container swal2-center swal2-backdrop-show"
		...
		<div aria-labelledby="swal2-title" aria-describedby="swal2-content"
			...
			<div class="swal2-content">
				<div id="swal2-content" class="swal2-html-container"
					style="display: block;">이메일 형식이 잘못되었습니다.</div>
				<input class="swal2-input" style="display: none;"><input
					type="file" class="swal2-file" style="display: none;">
				<div class="swal2-range" style="display: none;">
					<input type="range">
...
<c:if test="${check == 0 }">
	<div class="swal2-container swal2-center swal2-backdrop-show"
		...
		<div aria-labelledby="swal2-title" aria-describedby="swal2-content"
			...
			<div class="swal2-content">
				<div id="swal2-content" class="swal2-html-container"
					style="display: block;">가입하지 않은 아이디이거나, 잘못된 비밀번호입니다.</div>
				<input class="swal2-input" style="display: none;"><input
					type="file" class="swal2-file" style="display: none;">
				<div class="swal2-range" style="display: none;">
					<input type="range">
...
<c:if test="${check == 1 }">
	<div class="swal2-container swal2-center swal2-backdrop-show"
		...
		<div aria-labelledby="swal2-title" aria-describedby="swal2-content"
			...
			<div class="swal2-content">
				<div id="swal2-content" class="swal2-html-container"
					style="display: block;">카카오로 가입된 계정입니다. 카카오로 로그인해 주세요.</div>
				<input class="swal2-input" style="display: none;"><input
					type="file" class="swal2-file" style="display: none;">
				<div class="swal2-range" style="display: none;">
					<input type="range">
...
<c:if test="${check == 2 }">
	<div class="swal2-container swal2-center swal2-backdrop-show"
		...
		<div aria-labelledby="swal2-title" aria-describedby="swal2-content"
			...
			<div class="swal2-content">
				<div id="swal2-content" class="swal2-html-container"
					style="display: block;">구글로 가입된 계정입니다. 구글로 로그인해 주세요.</div>
				<input class="swal2-input" style="display: none;"><input
					type="file" class="swal2-file" style="display: none;">
				<div class="swal2-range" style="display: none;">
					<input type="range">
